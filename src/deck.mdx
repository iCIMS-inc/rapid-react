...
7 > "todos" is our state, an array of todo item strings
7[2:6] > "setTodos" is a function to set the state to a new value
7 > "['test1', 'test2']" is the initial value of the todos state
```
