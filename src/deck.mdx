...
40:47 > What we need for our Form component
```

---

```javascript lib/Form.jsx
import React from 'react';
import {
  Button,
  TextField,
...
9:16 > Form component
11[3:9],14[9:15] > Convert functions to props
```
---
...
----
* > 
3,10 > Remove the Text and Button imports
...
41 > Still need to set a key
42 > Our todo item text
43 > Keep onDelete functionality outside
* > Shorter, more readable application code
35, 40:44 > Custom components
```
---
